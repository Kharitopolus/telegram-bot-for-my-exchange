LEXICON: dict[str, str] = {
    ...
    "fill_username": "Чтобы прервать заполнение формы введите /cancel."
    " \n\nВведите имя пользователя",
    "fill_password": "Введите пароль",
    "wrong_credentials": "Неверное имя пользователя или пароль."
    " \n\nПопробовать снова: /login",
    "log_in_successfully": "Вы авторизировались",
    "fill_instrument": "Чтобы прервать заполнение формы введите /cancel."
    " \n\nВыберите инструмент",
    "user_dont_login":
    ...
    "confirm_order_?": "Вы подтверждайте выставление ордера:",
...
LEXICON_COMMANDS: dict[str, str] = {
    ...
    "/quote": "<<имя инструмента>>(обязательно). Показывает котировки.",
    "/make_order":
